_base_ = [
    ...
    '../_base_/models/motionnet_02pillar_stpn_nus.py',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            box_type_3d='LiDAR')),
    val=dict(pipeline=test_pipeline, classes=class_names, ann_file=data_root + 'motion_mini/nus_5_sweeps_infos_val.pkl',),
