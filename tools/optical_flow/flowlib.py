#!/usr/bin/python
"""
Source:https://github.com/vt-vl-lab/pwc-net.pytorch/blob/master/PWC_src/flowlib.py
# ==============================
# flowlib.py
...
def dispOpticalFlow (Image, Flow, Divisor=8, name='arrow' ):
    """
    Source: https://github.com/nabulago/anomaly-event-detection/blob/master/mylib.py#L172
