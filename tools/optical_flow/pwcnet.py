"""
Credits: Deqing Sun and Xiaodong Yang and Ming-Yu Liu and Jan Kautz; 
...
__all__ = [
    'pwc_dc_net', 'pwc_dc_net_old', 'compute_flow'
    ]
...
# net = pwc_dc_net("/home/ajinkya/repos/PillarMotion/mmdetection3d/tools/optical_flow/pwc_finetune.pth.tar")
net = pwc_dc_net("tools/optical_flow/pwc_finetune.pth.tar")
net = net.cuda()
net.eval()

# Source: https://github.com/NVlabs/PWC-Net/blob/master/PyTorch/script_pwc.py
...
#     H_ = int(ceil(H/divisor) * divisor/2)
#     W_ = int(ceil(W/divisor) * divisor/2)
#     for i in range(len(im_all)):
#         im_all[i] = cv2.resize(im_all[i], (W_, H_))

#     for _i, _ in enumerate(im_all):
#         im_all[_i] = im_all[_i]/255.0
